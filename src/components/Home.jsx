    ...
    return(
        ...
        <section className="grid grid-cols-1 md:grid-cols-2 mt-10 w-[90%] mx-auto py-6 gap-12">
          ...
          <div className="space-y-6 mt-10">
            ...
            <h1 className="text-5xl font-semibold leading-tight">Building Modern Web Interfaces</h1>
          ...
          <div className="">
            <img className="h-130 w-130 rounded-2xl shadow-sm shadow-pink-500 object-cover" alt="Mary-Cynthia" src={heroPic}/>
          </div>
