    ...
    return(
        <motion.section id="footer" variants = {fadeUp} initial="hidden" whileInView="show" viewport={{once:true, amount:0.2}} className="mt-22 w-[90%] mx-auto py-6 ">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:flex lg:justify-between">
              ...
              <div className="">
                <h1 className="dark:text-white text-[#c81a6e] font-bold text-2xl mb-5">MaryCynthia</h1>
                <p className="dark:text-gray-400 mb-4 max-w-[80%]">Crafting seamless digital experiences with modern technologies.</p>
                <div className="dark:bg-zinc-900 dark:border-zinc-800 flex gap-2 items-center mb-3 max-w-60 border bg-pink-50  border-pink-600 text-center p-2 rounded-xl text-sm">
                  <h3 className="text-[#c81a6e] text-lg"><FaEnvelope/></h3>
                  <p className="dark:text-white">Oluebube9301@gmail.com</p>
                </div>
                <div className="dark:bg-zinc-900 dark:border-zinc-800 flex gap-2 items-center mb-3 max-w-60 border bg-pink-50  border-pink-600 text-center p-2 rounded-xl text-sm">
                   <h3 className="text-[#c81a6e] text-lg"><FaLocationDot/></h3>
                   <p className="dark:text-white">Anambra State, Nigeria.</p>
                </div>

              </div>

              <div className="mt-4 mr-20">
                <h1 className="dark:text-white text-[#c81a6e] font-bold text-xl mb-5">Quick Links</h1>
                <div className="dark:text-gray-400 space-y-2 font-semibold grid">
              ...
              <div className="space-y-5 mt-4 mb-8">
                <h1 className="dark:text-white text-[#c81a6e] font-bold text-xl">Connect with me</h1>
                <p  className="dark:text-gray-400">Let's create something amazing together.</p>
            ...
            <div className="dark:border-t-gray-400 md:flex justify-between mt-16 text-xs grid grid-cols-1 gap-2 border-t">
                <p className="dark:text-gray-400 mt-10">&copy; 2026 Nwanokwara MaryCynthia. All rights reserved</p>
                <p className="dark:text-gray-400 flex items-center gap-1 mt-10">Built with <FaHeart className="text-pink-600"/> using React & Tailwind CSS.</p>
            </div>
        </motion.section>
    )
}